      ...
      <section class="content">
        ...
        <div class="box">
          <div class="box-header with-border">
            <a href="{{ url('pembayaran/add') }}" class="btn btn-success"><i class="fa fa-plus-circle"></i>Tambah</a>
          <div class="box-body">
            ...
            <table class="table table-stripped">
              ...
              <tbody>
                ...
                <tr class="umkm-row" data-index="{{ $index }}">
                  ...
                  <td>{{ $row->tgl_bayar }}</td>
                  <td>
                    <a href="{{ url("pembayaran/$row->id/edit") }}" class="btn btn-sm btn-warning"><i class="fa fa-pencil"></i></a>
                    <form action="{{ url("pembayaran/$row->id/delete") }}" method="POST" style="display:inline;">
                      {{ csrf_field() }}
                      {{ method_field('DELETE') }}
